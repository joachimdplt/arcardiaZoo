...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.connections.mongodb.port' => 'integer',
            'database.connections.mongodb.database' => 'string',
            'database.connections.mongodb.username' => 'NULL',
            'database.connections.mongodb.password' => 'NULL',
            'database.connections.mongodb.options.database' => 'string',
            ...
            'filesystems.links./Users/joakmann/Desktop/arcardiaZoo/public/storage' => 'string',
...
'database.connections.sqlsrv.charset','database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.mongodb.driver','database.connections.mongodb.host',
'database.connections.mongodb.port','database.connections.mongodb.database','database.connections.mongodb.username','database.connections.mongodb.password','database.connections.mongodb.options.database',
...
'filesystems.disks.s3.throw','filesystems.links./Users/joakmann/Desktop/arcardiaZoo/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'cors.supports_credentials','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist','inertia.testing.page_paths',
'inertia.testing.page_extensions','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'sanctum.csrf-cookie','roles.index','roles.store','roles.show',
'roles.update','roles.destroy','services.index','services.store','services.show',
'services.update','services.destroy','breeds.index','breeds.store','breeds.show',
'breeds.update','breeds.destroy','images.index','images.store','images.show',
'images.update','images.destroy','animals.index','animals.store','animals.show',
'animals.update','animals.destroy','habitats.index','habitats.store','habitats.show',
'habitats.update','habitats.destroy','reviews.index','reviews.store','reviews.show',
'reviews.update','reviews.destroy','veterinary-reports.index','veterinary-reports.store','veterinary-reports.show',
'veterinary-reports.update','veterinary-reports.destroy','users.index','users.store','users.show',
'users.update','users.destroy','client.home',
'login','legal.mentions','logout','dashboard',
'profile.edit','profile.update','profile.destroy','admin.users','admin.users.edit',
'admin.users.create','admin.users.store','admin.users.update','admin.users.destroy','admin.habitats',
'admin.habitats.create','admin.habitats.store','admin.habitats.edit','admin.habitats.show','admin.habitats.update',
'admin.habitats.destroy','admin.animals','admin.animal.create',
'admin.animal.store','admin.animals.show','admin.animals.update','admin.animals.edit','admin.animals.destroy','admin.services','admin.services.create','admin.services.store','admin.services.edit',
'admin.services.update','admin.services.destroy','admin.veterinary-reports.index','admin.veterinary-reports.create',
'admin.veterinary-reports.store','admin.veterinary-reports.show','admin.veterinary-reports.edit','admin.veterinary-reports.update','animals.veterinary-reports',
'admin.veterinary-reports.destroy','admin.animals.habitats','admin.breeds','admin.breeds.create','admin.breeds.store',
'admin.breeds.destroy','admin.reviews','admin.reviews.create','admin.reviews.store','admin.reviews.edit',
'admin.reviews.update','admin.reviews.destroy','admin.reviews.approve','admin.contacts','admin.habitatStats',
'admin.stats','admin.animalStats','animals.feedings.store','animal.feedings','client.services',
'client.service.show','client.habitats','client.habitat.show','client.animal.show','client.reviews.store','client.contact','habitat.recordClick','animal.recordClick','admin.documentation',
...
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','DB_CONNECTION','DB_HOST',
'DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD','DB_CONNECTION_MONGODB',
'MONGODB_URI','LOG_CHANNEL','SESSION_DRIVER','SESSION_LIFETIME','CACHE_STORE',
