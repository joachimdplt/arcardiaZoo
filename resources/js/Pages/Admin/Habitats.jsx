...
export default function Habitats({ habitats, userRoles = [] }) {
    ...
    const isAdmin = userRoles?.includes('Admin'); // ✅ Vérification sécurisée
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            {/* Vérification que habitats est bien défini avant d'afficher la table */}
            {habitats?.length > 0 ? (
                ...
                <p className="text-center text-gray-600">Aucun habitat trouvé.</p>
            )}
